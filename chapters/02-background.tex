...
\end{equation}
Analogously, one can define the variable $c_{\text{han}}$, where either of the lepton momenta components parallel to the parent top quark momentum in the \ttbar rest frame is flipped before taking the inner product \cite{bernreuther_nlospin_2004,bernreuther_spin_observables}.