...
A summary of the particle content is shown in Fig.~\ref{fig:standard_model_particles}.
...
\begin{figure}{t}
    \centering
    \subfigure[\label{fig:top_production_qq_s_channel}]{\includegraphics[width=0.3\textwidth]{figures/feynman-diagrams/ttbar_production_qq_s_channel.pdf}}\\
    \centering
    \subfigure[\label{fig:top_production_gg_t_channel}]{\includegraphics[width=0.3\textwidth]{figures/feynman-diagrams/ttbar_production_gg_t_channel.pdf}}
    \hfill
    \subfigure[\label{fig:top_production_gg_s_channel}]{\includegraphics[width=0.3\textwidth]{figures/feynman-diagrams/ttbar_production_gg_s_channel.pdf}}
    \hfill
    \subfigure[\label{fig:top_production_gg_u_channel}]{\includegraphics[width=0.3\textwidth]{figures/feynman-diagrams/ttbar_production_gg_u_channel.pdf}}
    \caption{Leading order Feynman diagrams for top quark pair production in \subref{fig:top_production_qq_s_channel} quark-antiquark annihilation and \subref{fig:top_production_gg_t_channel}, \subref{fig:top_production_gg_s_channel} \& \subref{fig:top_production_gg_u_channel} gluon fusion (ggF).}
...
The leading order (LO) Feynman diagrams for top quark pair production are shown in Fig.~\ref{fig:top_production}. 
