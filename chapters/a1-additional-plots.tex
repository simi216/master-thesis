...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Number of trainable parameters for different hyperparameter combinations for \subrefb{fig:hyperparameter_optimization_cross_attention_transformer_params} the \textsc{CrossAttentionTransformer} and \subrefb{fig:hyperparameter_optimization_feature_concat_transformer_params} the \textsc{FeatureConcatTransformer} architectures. Each square represents a model trained with the corresponding hyperparameter combination.}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{\textsc{FeatureConcatTransformer} with additional high-level features (HLF): \subrefb{fig:hyperparameter_optimization_feature_concat_transformer_HLF_accuracies} Assignment accuracy and \subrefb{fig:hyperparameter_optimization_feature_concat_transformer_HLF_efficiency} performance efficiency on the validation dataset for different hyperparameter combinations. Each dot represents a model trained with the corresponding hyperparameter combination. The dots are coloured according to the embedding dimension used in the model.
}
